...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Explore Pragathi Interiors' Allied Services, including custom furniture, aluminum and wooden partitions, toughened glass work, railing and SS grills, ACP glazing, wall texture painting, curtains, blinds, vinyl flooring, wallpaper, lamps, and UPVC doors and windows." />
        <meta name="keywords" content="furniture, aluminum partition, wooden partition, toughened glass work, SS railing, SS grill, ACP glazing, wall texture painting, interior painting, exterior painting, curtains, blinds, vinyl flooring, imported wallpaper, murals, lamps, UPVC doors, UPVC windows, interior solutions, home decor, office interiors" />
    </head>
            ...
            <!-- END PAGE LINE-->
             ...
             <section class="allied-banner-sec p-t-100 p-b-65">
                <div class="banner-div">
                        <div class="banner-div">
                            <h1 class="title-1"><span class=" text-center">Allied Services</span></h1>
                        </div>
                </div>
            </section> 
            <!--Banner section start-->
                        ...
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-1.jpg" alt="Furniture" />
                                    </a>
                                </figure>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-2.jpg" alt="Aluminum & Wooden Partition" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-3.jpg" alt="Toughened Glass work" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-4.jpg" alt="Railing & SS Grill" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-6.jpg" alt="ACP and Glazing" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-7.jpg" alt="Wall texture painting" />
                                    </a>
                                </figure>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-8.jpg" alt="Painting Interior & Exterior" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/allied-9.jpg" alt="Curtains and Blinds" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                    <img src="images/pragathi-images/allied-10.jpg" alt="Vinyl Flooring" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                                    ...
                                    assuring you the best polishing and finishing.
                                    </p>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                    <img src="images/pragathi-images/allied-11.avif" alt="Imported Wall paper and sticker’s murals" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                    <img src="images/pragathi-images/allied-12.jpg" alt="Lamps" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                    <img src="images/pragathi-images/allied-13.avif" alt="UPVC Door & Window" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                
                                <div class="media__content">
                                    ...
                                    <p class="media__text">UPVC Doors applicable in homes, offices, restaurant, hotels and many other places provided specially
                                        ...
                                        available in various designs.</p>
                                </div>
                            </div>
                        </article>
                    </div>
