        ...
        <main id="main">
            ...
            <section>
                <div class="rev_slider_wrapper">
                    <div class="rev_slider fullwidthabanner js-rev" data-version="5.4.4" style="display:none" data-rev-layout="fullscreen" data-rev-stylearrow="au-rev-arrow-2" data-rev-bullets="false" data-rev-stylebullet="au-rev-bullet-2" data-rev-voffbullet="40" data-rev-spacebullet="20">
                        <ul>
                            <li class="rev-item rev-item-1" data-transition="crossfade">
                                <img class="rev-slidebg" src="images/slide-02.jpg" alt="Master Slider 01" />
                                ...
                                data-videostartat="00:07" 
                                data-videoendat="00:32"
                                data-autoplay="on" 
                ...
                <div class="container">
                    ...
                    <div class="section-row section-row--fit">
                        <div class="media-statistic">
                            <span class="ti-cup media__icon wow fadeInLeft" data-wow-delay="0.2s"></span>
                            <div class="media__body">
                                <span class="number js-counterup">18</span>
                                <h4 class="name">Years of experience</h4>
                            </div>
                        </div>
                        <div class="media-statistic">
                            <span class="ti-user media__icon wow fadeInLeft" data-wow-delay="0.2s"></span>
                            <div class="media__body">
                                <span class="number js-counterup">126</span>
                                <h4 class="name">happy cilents</h4>
                            </div>
                        </div>
                        <div class="media-statistic">
                            <span class="ti-home media__icon wow fadeInLeft" data-wow-delay="0.2s"></span>
                            <div class="media__body">
                                <span class="number js-counterup">224</span>
                                <h4 class="name">completed project</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="section-row section-row--p-sm">
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-05.jpg" alt="luxury villa" />
                                    </figure>
                                    <div class="media__body">
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-06.jpg" alt="wooden villa" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-07.jpg" alt="Stiff homestay" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-08.jpg" alt="Frozen house" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                        ...
                        <div class="section-row section-row--p-sm">
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-09.jpg" alt="luxury villa" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                                            <a href="project-grid-full.php">luxury villa</a>
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-10.jpg" alt="wooden villa" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                                            <a href="project-grid-full.php">wooden villa</a>
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-11.jpg" alt="luxury villa" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                                            <a href="project-grid-full.php">luxury villa</a>
                            ...
                            <div class="section-col-3">
                                <article class="media-project-2">
                                    <figure class="media__img">
                                        <img src="images/project-12.jpg" alt="wooden villa" />
                                    </figure>
                                    <div class="media__body">
                                        <h3 class="media__title">
                                            <a href="project-grid-full.php">wooden villa</a>
            ...
            <!-- SERVICE-->
            <section class="section bg-pattern-01 p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-9">
                            <div class="service-wrap">
                                <div class="media-service-2">
                                    ...
                                    <div class="media__body">
                                        <div class="media__icon">
                                            <img src="images/icon/service-01.png" alt="service 1">
                                        </div>
                                ...
                                <div class="media-service-2">
                                    ...
                                    <div class="media__body">
                                        <div class="media__icon">
                                            <img src="images/icon/service-02.png" alt="service 2">
                                        </div>
                                        <h4 class="media__title">
                                            <a href="#">interior</a>
                                        </h4>
                                ...
                                <div class="media-service-2">
                                    ...
                                    <div class="media__body">
                                        <div class="media__icon">
                                            <img src="images/icon/service-03.png" alt="service 3">
                                        </div>
                                        <h4 class="media__title">
                                            <a href="#">planning</a>
                                        </h4>
