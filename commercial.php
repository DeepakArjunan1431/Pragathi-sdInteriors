                        ...
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-1.jpg" alt="Office" />
                                    </a>
                                </figure>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-2.jpg" alt="Hospital" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-3.jpg" alt="Showroom" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-4.jpg" alt="Hotel" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-5.jpg" alt="Restaurant" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-7.jpg" alt="Education Institution" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-8.jpg" alt="Spa & Salons" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-9.jpg" alt="Gym & Home Theater" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
                    ...
                    <div class="container-fluid">
                        <article class="media-project-3 right">
                            <div class="media__body">
                                <figure class="media__img">
                                    <a>
                                        <img src="images/pragathi-images/com-10.jpg" alt="Government Projects" />
                                    </a>
                                </figure>
                                <span><a href="contact.php" class="add">KNOW MORE</a></span>                                <div class="media__content">
                                    <div class="pointer"></div>
